...
type LayoutRouteId = RouteId | "/" | "/about" | "/login" | "/movies/[id]" | "/movies/[view=list]" | "/search" | "/watchlist" | null
type LayoutParams = RouteParams & { id?: string; view?: MatcherParam<typeof import('../../../../src/params/list').match> }
